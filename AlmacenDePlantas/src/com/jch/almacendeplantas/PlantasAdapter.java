...
public class PlantasAdapter extends BaseAdapter {
	...
	// * BUSCAR ---------------------------------------------int index =
	// Collections.binarySearch(arrayList, "people");
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			vistaPersonalizada = layoutPersonal.inflate(R.layout.item_planta,
					null);
		}
		Planta planta = plantasBBDD.get(position);
		imagenPlanta = (ImageView) vistaPersonalizada
				.findViewById(R.id.img_planta);
		imagenPlanta.setImageResource(planta.getIdImagen());
		txtTitulo = (TextView) vistaPersonalizada
				.findViewById(R.id.txt_titulo_planta);
		txtTitulo.setText(planta.getNombreCientifico());
		txtSubtitulo = (TextView) vistaPersonalizada
				.findViewById(R.id.txt_subtitulo_planta);
			...
			listadoPlantas
					.add(new Planta(
							...
							"Subtitulo con descripcion de pruebas Subtitulo con descripcion de pruebas"
									+ "Subtitulo con descripcion de pruebas Subtitulo con descripcion de pruebas"
									+ "Subtitulo con descripcion de pruebas",
							"Familia 1", "Tipo 1"));
		}
		return listadoPlantas;
	}

	private static int[] imagenesDePrueba = { R.drawable.sample_2,
			R.drawable.sample_3, R.drawable.sample_4, R.drawable.sample_5,
			R.drawable.sample_6, R.drawable.sample_7, R.drawable.sample_7,
